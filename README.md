...
```
./walletd --container-file=YOURWALLETNAME --container-password=YOURWALLETPASSWORD --daemon-port=35001 --bind-port=35002 --rpc-legacy-security --generate-container
```

-  Start the wallet using walletd

```
./walletd --container-file=YOURWALLETNAME --container-password=YOURWALLETPASSWORD --daemon-port=35001 --bind-port=35002 --rpc-legacy-security
```
...
"payments": {
    ...
    "transferFee": 20000, //fee to pay for each transaction
    "minPayment": 10000000, //miner balance required before sending payment
    "maxTransactionAmount": 5000000000, //split transactions by this amount(to prevent "too big transaction" error)
